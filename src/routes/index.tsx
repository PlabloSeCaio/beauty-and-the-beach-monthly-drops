...
import { carousels, blogs, newsletters, meta } from "@/lib/beauty-and-the-beach-content";

export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Beauty and the Beach Salon — Content Preview" },
      {
        name: "description",
        content:
          "Monthly content drop preview for Beauty and the Beach Salon: Instagram grid, carousels, blog posts and newsletters.",
      },
    ],
  }),
  component: Index,
    ...
    <div className="min-h-screen scroll-smooth bg-background text-foreground">
      ...
      <section className="mx-auto max-w-6xl px-6 pt-16 pb-12">
        ...
        <h1 className="mt-3 text-4xl font-semibold tracking-tight md:text-5xl">
          Beauty and the Beach Salon — Monthly Drop
        </h1>
              ...
              <button
                ...
                onClick={() =>
                  ...
                  setLightbox({
                    ...
                    alt: c.title,
                    aspect: "post",
                    downloadFilename: `beauty-and-the-beach-carousel-${c.id}-slide-1.png`,
                  })
                }
                        ...
                        <button
                          ...
                          onClick={() =>
                            setLightbox({
                              ...
                              aspect: "post",
                              downloadFilename: `beauty-and-the-beach-carousel-${c.id}-slide-${i + 1}.png`,
                            })
                          }
              ...
              <div className="flex gap-4">
                <div className="flex-1">
                  <ImageOrPlaceholder
                    ...
                    alt={b.title}
                    aspect="landscape"
                    downloadFilename={`beauty-and-the-beach-blog-${b.id}-banner.png`}
                  />
                </div>
                <button
                  type="button"
                  onClick={() =>
                    ...
                    setLightbox({
                      ...
                      alt: `${b.title} story`,
                      aspect: "portrait",
                      downloadFilename: `beauty-and-the-beach-blog-${b.id}-story.png`,
                    })
                  }
              ...
              <button
                ...
                onClick={() =>
                  ...
                  setLightbox({
                    ...
                    alt: n.title,
                    aspect: "landscape",
                    downloadFilename: `beauty-and-the-beach-newsletter-${n.id}-banner.png`,
                  })
                }
                  ...
                  <>
                    ...
                    <button
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        e.preventDefault();
                        downloadImage(n.banner, `beauty-and-the-beach-newsletter-${n.id}-banner.png`);
                      }}
                  ...
                  <button
                    ...
                    onClick={() =>
                      setLightbox({
                        ...
                        alt: `${n.title} story`,
                        aspect: "portrait",
                        downloadFilename: `beauty-and-the-beach-newsletter-${n.id}-story.png`,
                      })
                    }
      ...
      <footer className="border-t border-border/60 py-10 text-center text-sm text-muted-foreground">
        Prepared for Beauty and the Beach Salon. July 2026.
      </footer>
